...
// import { BadgeCheck, ArrowUpRight, ShieldCheck, Award, BookOpen, BarChart3, Brain, Map } from 'lucide-react';
...
//   const baseY = useTransform(scrollYProgress, [0, 1], [-25, 0]);
...
//             const yMultiplier = index % 2 === 0 ? 1 : -1;
...
//                     style={{ y: baseYSpring, scaleY: yMultiplier }}
//                   >
//                     <Image
//                       src={cert.image}
//                       alt={cert.title}
...
//                           onClick={() => cert.credential && window.open(cert.credential, '_blank')}
//                           disabled={!cert.credential}
...
//                   style={{ 
//                     y: baseYSpring,
//                     // Removed the scaleY multiplication that was causing the flip
//                   }}
//                 >
//                   <Image
//                     src={cert.image}
...
//                   {/* Hover Overlay */}
//                   <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent flex flex-col justify-between p-4 opacity-0 group-hover:opacity-100 transition-all duration-300">
//                     <div className="flex justify-end">
//                       <motion.button
//                         className="p-2 bg-black/50 backdrop-blur-sm rounded-full hover:bg-emerald-400/20 transition-colors group/btn"
//                         onClick={() => cert.credential && window.open(cert.credential, '_blank')}
//                         disabled={!cert.credential}
//                         aria-label="View credential"
//                         type="button"
...
//                         whileTap={{ scale: 0.95 }}
//                       >
//                         <ArrowUpRight className="w-5 h-5 text-emerald-400 group-hover/btn:text-white transition-colors" />
//                       </motion.button>
//                     </div>
...
//                           className="px-3 py-1 text-xs font-medium bg-emerald-400/20 text-emerald-300 rounded-full border border-emerald-400/30"
//                         >
//                           {tech}
//                         </motion.span>
//                       ))}
//                       {cert.tech.length > 3 && (
//                         <span className="px-3 py-1 text-xs font-medium bg-emerald-400/20 text-emerald-300 rounded-full border border-emerald-400/30">
//                           +{cert.tech.length - 3}
//                         </span>
//                       )}
//                     </div>
...
//             {/* Quote Marks */}
//             <div className="absolute top-4 left-6 text-6xl text-emerald-400/20 font-serif">&quot;</div>
//             <div className="absolute bottom-4 right-6 text-6xl text-emerald-400/20 font-serif rotate-180">&quot;</div>
...
//       <motion.div
//         className="absolute top-1/4 right-0 w-[600px] h-[600px] bg-gradient-radial from-emerald-500/10 to-transparent blur-3xl -z-10"
//         animate={{ rotate: 360 }}
//         transition={{ duration: 50, repeat: Infinity, ease: 'linear' }}
//       />
//       <motion.div
//         className="absolute bottom-1/3 left-0 w-[800px] h-[800px] bg-gradient-radial from-cyan-500/8 to-transparent blur-3xl -z-10"
//         animate={{ rotate: -360 }}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {/* Enhanced Hover Overlay - REMOVED ArrowUpRight button */}
