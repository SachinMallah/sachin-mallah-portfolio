...
//             <p className="text-xl text-gray-300">Credentials I've Earned</p>
//           </motion.div>
//         </AnimatePresence>
...
//             >
//               {/* Glass-morphism Card */}
//               <div className="h-full bg-black/80 backdrop-blur-xl rounded-3xl p-6 border-2 border-gray-500/30 shadow-2xl transition-all hover:border-gray-400/50">
//                 {/* Image Container */}
...
//               {/* Hover Glow Effect */}
//               <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 opacity-0 group-hover:opacity-100 transition-opacity -z-10 blur-xl" />
//             </motion.div>
//           ))}
//         </div>

//         {/* Decorative Elements */}
//         <div className="absolute top-1/4 right-32 w-96 h-96 bg-emerald-500/10 rounded-full blur-3xl -z-10" />
//         <div className="absolute bottom-1/4 left-32 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl -z-10" />
//       </div>
//     </section>
//   );
// };
...
// import { motion, useScroll, useTransform, useSpring, AnimatePresence } from 'framer-motion';
// import { BadgeCheck, ArrowUpRight, ZoomIn, ShieldCheck } from 'lucide-react';
// import Image from 'next/image';
...
//     credential: "https://example.com/verify/789"
//   },
// ];
...
//               >
//                 {/* Hover Glow */}
//                 <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/20 to-cyan-500/20 opacity-0 group-hover:opacity-100 transition-opacity rounded-3xl" />
...
// import { BadgeCheck, BrainCircuit, Atom, ScanEye, CircuitBoard } from 'lucide-react';
// import Image from 'next/image';
// import dynamic from 'next/dynamic';

// // Dynamic imports for heavy components
// const NeuralNetwork = dynamic(() => import('./NeuralNetwork'), { ssr: false });
// const HologramRenderer = dynamic(() => import('./HologramRenderer'), { ssr: false });

// const certificatesData = [
//   {
//     id: "cert-1",
//     title: "Neuro-Machine Learning",
//     issuer: "DeepLearning.AI",
//     date: "Issued May 2024",
//     image: "/certificates/neuro-ml.jpg",
//     hologram: "/holograms/ml-hologram.glb",
//     neuralNodes: 128,
//     quantumLevel: 0.92,
...
//     image: "/certificates/quantum-web.jpg",
//     hologram: "/holograms/web-hologram.glb",
//     neuralNodes: 96,
//     quantumLevel: 0.87,
//     dimensions: { width: 1280, height: 720 }
//   },
...
//     issuer: "AWS Singularity",
//     date: "Issued Mar 2024",
//     image: "/certificates/inter-cloud.jpg",
//     hologram: "/holograms/cloud-hologram.glb",
//     neuralNodes: 256,
//     quantumLevel: 0.95,
//     dimensions: { width: 1280, height: 720 }
//   },
...
// const QuantumCertificationCard = ({ cert, index }) => {
...
//   const rotateX = useSpring(useTransform(mouseY, [0, 300], [15, -15]), { damping: 30 });
//   const rotateY = useSpring(useTransform(mouseX, [0, 300], [-15, 15]), { damping: 30 });
...
//   return (
//     <motion.div 
//       className="relative h-full group/quantum"
//       ref={cardRef}
//       initial={{ opacity: 0, scale: 0.95 }}
//       animate={{ opacity: 1, scale: 1 }}
...
//         <NeuralNetwork 
//           nodes={cert.neuralNodes} 
//           active={neuralActive}
//           className="text-emerald-400/20"
//         />
//       </div>

//       {/* 4D Holographic Interface */}
//       <motion.div
//         className="h-full bg-black/90 backdrop-blur-2xl rounded-4xl p-8 border-2 border-emerald-400/30 shadow-quantum overflow-hidden"
//         style={{
//           rotateX,
//           rotateY,
...
//         <div className="relative h-[400px] mb-8 rounded-3xl overflow-hidden border border-emerald-400/20">
//           <HologramRenderer 
//             modelPath={cert.hologram} 
//             interactive 
//             quantumLevel={cert.quantumLevel}
//             className="absolute inset-0"
//           />
          
//           {/* Neural Activation Overlay */}
//           <div 
//             className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent flex flex-col justify-between p-6 opacity-0 group-hover/quantum:opacity-100 transition-opacity"
//             onMouseEnter={() => setNeuralActive(true)}
//             onMouseLeave={() => setNeuralActive(false)}
//           >
//             <div className="flex justify-between items-start">
//               <div className="flex items-center gap-2 text-emerald-400">
//               <CircuitBoard className="w-6 h-6 text-emerald-400" />
//                 {/* <QuantumComputing className="w-6 h-6" /> */}
//                 <span className="font-mono text-sm">Quantum Level: {cert.quantumLevel}</span>
//               </div>
//               <motion.button 
//                 className="p-2 bg-emerald-400/10 rounded-xl hover:bg-emerald-400/20 transition-colors flex items-center gap-2"
//                 whileTap={{ scale: 0.95 }}
//               >
...
//               <span className="font-mono text-sm">Neural Nodes: {cert.neuralNodes}</span>
//             </div>
//           </div>
//         </div>

//         {/* Quantum Certification Body */}
//         <div className="space-y-6">
//           <div className="flex items-start gap-5">
//             <motion.div 
//               className="relative flex-shrink-0"
//               animate={{ rotate: neuralActive ? 360 : 0 }}
...
//             </motion.div>
//             <div>
//               <h3 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400 mb-2">
//                 {cert.title}
//               </h3>
//               <p className="text-sm text-gray-400 font-mono tracking-widest">{cert.issuer}</p>
//             </div>
//           </div>

//           {/* Temporal Validation Badge */}
//           <motion.div 
//             className="flex items-center justify-between p-4 bg-black/50 rounded-xl backdrop-blur-sm border border-emerald-400/20"
//             whileHover={{ scale: 1.02 }}
//           >
//             <span className="text-sm text-gray-400 font-mono">{cert.date}</span>
//             <div className="flex items-center gap-2">
//               <div className="relative">
//                 <div className="absolute inset-0 bg-emerald-400/20 blur-lg rounded-full" />
//                 <span className="relative text-xs font-bold text-emerald-400 tracking-wider">
//                   MULTIVERSE VALID
//                 </span>
//               </div>
//               <div className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse" />
...
//           <div className="absolute -inset-8 bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 blur-3xl animate-quantum-pulse" />
//         </div>
//       </motion.div>
//     </motion.div>
//   );
...
//             }}
//           >
//             <BrainCircuit className="w-24 h-24 text-emerald-400" strokeWidth={1} />
//           </motion.div>
//           <h1 className="text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-cyan-400 to-purple-400 mb-4">
//             Neuro-Quantum Certifications
//           </h1>
//           <p className="text-2xl text-gray-300 font-light tracking-wide">
//             Verified Across Multiple Timelines
//           </p>
//         </motion.div>

//         {/* Quantum Timeline */}
//         <motion.div
//           className="absolute left-1/2 top-0 w-1 h-full bg-gradient-to-b from-emerald-400/50 via-cyan-400/80 to-purple-400/50"
//           style={{ scaleY: pathLength }}
//         />

//         {/* Quantum Grid */}
//         <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-24 px-4">
//           {certificatesData.map((cert, index) => (
//             <QuantumCertificationCard
//               key={cert.id}
//               cert={cert}
//               index={index}
//             />
...
//         <div className="absolute inset-0 -z-10">
//           <motion.div
//             className="absolute top-1/3 left-1/4 w-[1500px] h-[1500px] bg-radial-gradient(from-60% at 50% 50%, #05966910 0%, transparent 70%)"
//             animate={{
//               rotate: [0, 360],
//               scale: [1, 1.5, 1]
//             }}
...
//           />
//           <motion.div
//             className="absolute top-2/3 right-1/4 w-[1200px] h-[1200px] bg-radial-gradient(from-30% at 30% 70%, #06b6d410 0%, transparent 70%)"
//             animate={{
//               rotate: [360, 0],
//               scale: [1, 1.3, 1]
//             }}
