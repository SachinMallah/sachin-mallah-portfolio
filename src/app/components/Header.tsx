...
//   return (
//     <nav className="fixed w-full top-0 bg-white z-50 shadow-md border-b border-gray-200">
...
//             <NavLink href="#hero" onClick={handleNavClick}>
//               Home
//             </NavLink>
...
//               Skills
//             </NavLink>
//             <NavLink href="#difference" onClick={handleNavClick}>
//               My Edge
//             </NavLink>
...
//               className="text-gray-600 hover:text-black transition-colors p-2 rounded-lg"
...
//             <MobileNavLink href="#hero" onClick={handleNavClick}>
//               Home
//             </MobileNavLink>
...
//               Projects
//             </MobileNavLink>
//             <MobileNavLink href="#skills" onClick={handleNavClick}>
//               Skills
//             </MobileNavLink>
//             <MobileNavLink href="#difference" onClick={handleNavClick}>
//               My Edge
//             </MobileNavLink>
...
//                  after:h-0.5 after:bg-black after:transition-all hover:after:w-full"
//     >
//       {children}
//     </a>
//   );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <NavLink href="#certificates" onClick={handleNavClick}>
              Certificates
            </NavLink>
            <NavLink href="#projects" onClick={handleNavClick}>
              Projects
          ...
          {isMenuOpen && (
            ...
            >
              <div className="px-2 pt-2 pb-4 space-y-1 bg-black/80 backdrop-blur-xl rounded-lg mt-2 border border-gray-500/30">
                ...
                <MobileNavLink href="#education" onClick={handleNavClick}>
                  Education
                </MobileNavLink>
                <MobileNavLink href="#certificates" onClick={handleNavClick}>
                  Certificates
                </MobileNavLink>
                <MobileNavLink href="#projects" onClick={handleNavClick}>
                  Projects
