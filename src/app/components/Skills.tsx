...
//     return items.map(({ name, icon: Icon }) => (
//       <div
//         key={name}
//         className="group flex flex-col items-center p-4 rounded-lg hover:bg-gradient-to-br from-gray-50 to-gray-100 transition-all cursor-pointer"
//       >
//         <div className="mb-2 transition-transform duration-300 group-hover:scale-110">
//           <Icon className="w-12 h-12 filter grayscale group-hover:grayscale-0 transition-all duration-300" />
//         </div>
...
//             <h3 className="text-xl font-bold mb-6 border-b-2 border-black pb-2">Languages</h3>
//             <div className="grid grid-cols-2 gap-6">{renderSkills(skills.languages)}</div>
//           </div>

//           {/* Web Development */}
//           <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
//             <h3 className="text-xl font-bold mb-6 border-b-2 border-black pb-2">Web Development</h3>
//             {Object.entries(skills.webDevelopment).map(([subcat, items]) => (
//               <div key={subcat} className="mb-6">
//                 <h4 className="text-lg font-semibold mb-4 capitalize">{subcat}</h4>
//                 <div className="grid grid-cols-2 gap-6">{renderSkills(items)}</div>
//               </div>
//             ))}
//           </div>
...
//           {/* Machine Learning */}
//           <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
//             <h3 className="text-xl font-bold mb-6 border-b-2 border-black pb-2">Machine Learning</h3>
//             {Object.entries(skills.machineLearning).map(([subcat, items]) => (
//               <div key={subcat} className="mb-6">
//                 <h4 className="text-lg font-semibold mb-4 capitalize">{subcat}</h4>
//                 <div className="grid grid-cols-2 gap-6">{renderSkills(items)}</div>
//               </div>
...
//           {/* Deployment */}
//           <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
//             <h3 className="text-xl font-bold mb-6 border-b-2 border-black pb-2">Deployment</h3>
//             <div className="grid grid-cols-2 gap-6">{renderSkills(skills.deployment)}</div>
//           </div>

//           {/* Tools & Platforms */}
//           <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow col-span-full lg:col-span-4">
//             <h3 className="text-xl font-bold mb-6 border-b-2 border-black pb-2">Tools & Platforms</h3>
//             <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
//               {renderSkills(skills.toolsPlatforms)}
//             </div>
//           </div>
//         </div>
//       </div>
...
// // color svg python when cursor is there on it
